...
**Patience rule:** After spawning a teammate, **WAIT for their final completion message** before evaluating output. Teammates work in multiple steps — intermediate messages and partial artifacts do NOT mean they are done. Never read artifacts mid-flight and assume the work is incomplete. If unsure, send them a message — do not take over their task.
