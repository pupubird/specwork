...
**Patience rule:** After spawning any teammate, WAIT for their final completion message before acting. Teammates work in multiple steps. Intermediate messages, partial artifacts, and idle notifications do NOT mean they are done. Never read artifacts mid-flight and assume work is incomplete — if unsure, message the teammate. Do not take over their task.
