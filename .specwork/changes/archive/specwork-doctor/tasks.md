...
- [x] 4.1 Implement checkArchives() — validate each archive has .specwork.yaml (status: archived), required files, no loose graph.yaml/state.yaml/nodes/
...
- [x] 10.2 Integration tests for CLI command (specwork doctor, specwork doctor --fix, specwork doctor --category specs)
